...
class _SignUpWidgetState extends State<SignUpWidget>
  ...
  void initState() {
    ...
    _model.signUpBarController = TabController(
      vsync: this,
      length: 2,
      initialIndex: 0,
    )..addListener(() => safeSetState(() {}));
    _model.usernamedisplayTextController ??= TextEditingController();
    _model.usernamedisplayFocusNode ??= FocusNode();
                          ...
                          child: Column(
                            children: [
                              Align(
                                ...
                                child: TabBar(
                                  labelColor: const Color(0xFF4B3D26),
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: SizedBox(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .usernamedisplayTextController,
                                                focusNode: _model
                                                    .usernamedisplayFocusNode,
                                                autofocus: false,
                                                obscureText: false,
